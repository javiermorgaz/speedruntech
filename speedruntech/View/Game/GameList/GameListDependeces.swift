...
public class GameListDependences {
    ...
    public func GameListController() -> UIViewController {
        ...
        let gameListPresenter = GameListPresenter(gameListViewController: gameListViewController, gameListUseCase: gameListUseCase)
